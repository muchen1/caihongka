package com.rainbowcard.client.widget.adlibrary;
...
public class AdManager {
    ...
    public AdManager(Activity context, List<BannerEntity> bannerEntityList) {
    ...
    private View.OnClickListener imageOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (bannerEntity != null && onImageClickListener != null) {
                onImageClickListener.onImageClick(view, bannerEntity);
            }
        }
    };
    ...
    class AdAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            BannerEntity bannerEntity = bannerEntityList.get(position);
            ...
            Uri uri = Uri.parse(StringUtil.getUrl(bannerEntity.img,context));
