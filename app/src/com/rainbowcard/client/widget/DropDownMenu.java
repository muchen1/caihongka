...
public class DropDownMenu extends LinearLayout {
    ...
    public DropDownMenu(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        underLine.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, 2));
        underLine.setBackgroundColor(dividerColor);
        addView(underLine, 1);
...
//        tab.setPadding(dpTpPx(32), dpTpPx(12), dpTpPx(32), dpTpPx(12));
        tab.setPadding(dpTpPx(20), dpTpPx(12), dpTpPx(20), dpTpPx(12));
        //添加点击事件
        ...
        if (i < tabTexts.size() - 1) {
            ...
            view.setLayoutParams(new LayoutParams(2, ViewGroup.LayoutParams.MATCH_PARENT));
    ...
    public void setMyTabText(String text){
        ((TextView) tabMenuView.getChildAt(6)).setText(text);
    }
