...
public class AddressActivity extends MyBaseActivity implements AddressListAdapter.SetAddressListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UIUtils.setMiuiStatusBarDarkMode(AddressActivity.this,true);
        UIUtils.setMeizuStatusBarDarkIcon(AddressActivity.this,true);
    }
    ...
    private void initView(){
        ...
        mHeadControlPanel.setMiddleTitle(getString(R.string.select_consignee_address));
    ...
    void load(){
        token = String.format(getString(R.string.token), MyConfig.getSharePreStr(AddressActivity.this, Constants.USERINFO, Constants.UID));
...
//                            }
                            ...
                            mFlLoading.showError("暂无配送地址",false);
                        }
                    }
        ...
        withBtwVolley().load(String.format(getString(R.string.url),API.API_SET_DEFAULT_ADDRESS,arid))
                ...
                .setResponseHandler(new BtwVolley.ResponseHandler<String>() {
                    ...
                    public void onResponse(String resp) {
                        load();
                        Toast.makeText(AddressActivity.this, R.string.set_default_success,
                                Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onBtwError(BtwRespError<String> error) {
                        Toast.makeText(AddressActivity.this, error.errorMessage,
                                Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onNetworkError(VolleyUtils.NetworkError error) {
                        Toast.makeText(AddressActivity.this, R.string.network_error,
                                Toast.LENGTH_SHORT).show();
                    }
...
//        delAddress(id);
    ...
    void delAddress(int arid){
        ...
        withBtwVolley().load(String.format(getString(R.string.url),API.API_DEL_ADDRESS,arid))
                ...
                .setResponseHandler(new BtwVolley.ResponseHandler<String>() {
                    ...
                    public void onResponse(String resp) {
                        load();
                        Toast.makeText(AddressActivity.this, R.string.delete_success,
                                Toast.LENGTH_SHORT).show();
                    }
    ...
    private void showDialog(String title, String tip, final int arid) {
        final Dialog dialog = new Dialog(AddressActivity.this,R.style.loading_dialog);
