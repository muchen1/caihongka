...
public class SignCalendar extends ViewFlipper implements
  ...
  public static final int COLOR_BG_WEEK_TITLE = Color.parseColor("#55a0cd"); // 星期标题背景颜色
  ...
  public static final int COLOR_TX_THIS_DAY = Color.parseColor("#55a0cd"); // 当天日历数字颜色
