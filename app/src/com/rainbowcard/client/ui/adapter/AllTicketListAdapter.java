...
public class AllTicketListAdapter extends BaseAdapter {
    ...
    public AllTicketListAdapter(Context context) {
        mContext = context;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if(ticketStateEntity.isAdd == 1) {
            holder.countTv.setText(String.format(mContext.getString(R.string.add_count), ticketStateEntity.details));
            holder.countTv.setTextColor(mContext.getResources().getColor(R.color.money_color));
        }else {
            holder.countTv.setText(String.format(mContext.getString(R.string.reduce_count), ticketStateEntity.details));
