 ...
 */
public class MyPushIntentServer extends UmengMessageService {
    @Override
    public void onMessage(Context context, Intent intent) {
        try {
            ...
            UmLog.d("GCCCCCLLL", "message=" + message);      //消息体
            UmLog.d("GCCCCCLLL", "custom=" + msg.custom);    //自定义消息的内容
            UmLog.d("GCCCCCLLL", "title=" + msg.title);      //通知标题
            UmLog.d("GCCCCCLLL", "text=" + msg.text);        //通知内容
...
//                context.stopService(intent1);
            ...
            UmLog.e("GCCCCCLLL", e.getMessage());
        }
    }
}
